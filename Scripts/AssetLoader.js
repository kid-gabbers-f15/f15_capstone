var AssetLoader = function(game){
    ...
    var Preload = function(){
        ...
        game.load.image('Castle1', KCG_ASSET_PATH+'BaseStickers/Castle1.png');
        game.load.image('Castle2', KCG_ASSET_PATH+'BaseStickers/Castle2.png');
        game.load.image('Castle3', KCG_ASSET_PATH+'BaseStickers/Castle3.png');
        game.load.image('Castle4', KCG_ASSET_PATH+'BaseStickers/Castle4.png');
        game.load.image('Castle14', KCG_ASSET_PATH+'BaseStickers/Castle14.png');
        game.load.image('Castle15', KCG_ASSET_PATH+'BaseStickers/Castle15.png');
        game.load.image('Castle25', KCG_ASSET_PATH+'BaseStickers/Castle25.png');
        game.load.image('Person1', KCG_ASSET_PATH+'BaseStickers/Person1.png');
        game.load.image('Person2', KCG_ASSET_PATH+'BaseStickers/Person2.png');
        game.load.image('Person3', KCG_ASSET_PATH+'BaseStickers/Person3.png');
        game.load.image('Person4', KCG_ASSET_PATH+'BaseStickers/Person4.png');
        game.load.image('Person5', KCG_ASSET_PATH+'BaseStickers/Person5.png');
        game.load.image('Person6', KCG_ASSET_PATH+'BaseStickers/Person6.png');
        game.load.image('Person7', KCG_ASSET_PATH+'BaseStickers/Person7.png');
        game.load.image('Person8', KCG_ASSET_PATH+'BaseStickers/Person8.png');
        game.load.image('Person9', KCG_ASSET_PATH+'BaseStickers/Person9.png');
        game.load.image('Person10', KCG_ASSET_PATH+'BaseStickers/Person10.png');
        game.load.image('Person11', KCG_ASSET_PATH+'BaseStickers/Person11.png');
        game.load.image('Person12', KCG_ASSET_PATH+'BaseStickers/Person12.png');
        game.load.image('Person13', KCG_ASSET_PATH+'BaseStickers/Person13.png');
        game.load.image('Person14', KCG_ASSET_PATH+'BaseStickers/Person14.png');
        game.load.image('Person15', KCG_ASSET_PATH+'BaseStickers/Person15.png');
        game.load.image('Person16', KCG_ASSET_PATH+'BaseStickers/Person16.png');
        game.load.image('Person17', KCG_ASSET_PATH+'BaseStickers/Person17.png');
        game.load.image('Person18', KCG_ASSET_PATH+'BaseStickers/Person18.png');
        game.load.image('Person19', KCG_ASSET_PATH+'BaseStickers/Person19.png');
        game.load.image('Person20', KCG_ASSET_PATH+'BaseStickers/Person20.png');
        game.load.image('Person21', KCG_ASSET_PATH+'BaseStickers/Person21.png');
        game.load.image('Person22', KCG_ASSET_PATH+'BaseStickers/Person22.png');
        game.load.image('Person23', KCG_ASSET_PATH+'BaseStickers/Person23.png');
        game.load.image('Person24', KCG_ASSET_PATH+'BaseStickers/Person24.png');
        game.load.image('Person25', KCG_ASSET_PATH+'BaseStickers/Person25.png');
        game.load.image('Person26', KCG_ASSET_PATH+'BaseStickers/Person26.png');
        game.load.image('Person27', KCG_ASSET_PATH+'BaseStickers/Person27.png');
